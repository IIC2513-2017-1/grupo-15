...
class PledgesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pledge" do
    assert_difference('Pledge.count') do
      post pledges_url, params: { pledge: { amount: @pledge.amount, description: @pledge.description, title: @pledge.title } }
    end
  ...
  test "should update pledge" do
    patch pledge_url(@pledge), params: { pledge: { amount: @pledge.amount, description: @pledge.description, title: @pledge.title } }
